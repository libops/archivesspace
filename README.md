...
The application database password comes from `ARCHIVESSPACE_DB_PASSWORD`, while MariaDB uses `DB_ROOT_PASSWORD`. Docker secrets are imported into the container environment before config rendering.
